...
["vehiclesCivCar", ["RDS_tt650_Civ_01", 0.3
	,"RDS_Gaz24_Civ_03", 0.2
	,"RDS_Gaz24_Civ_02", 0.3
	,"RDS_Lada_Civ_01", 2.0
	,"RDS_MMT_Civ_01", 1.0
	,"RDS_Gaz24_Civ_01", 1.0				
	,"RDS_S1203_Civ_01", 0.2			
	,"RDS_Ikarus_Civ_01", 0.5			
	,"RDS_JAWA353_Civ_01", 0.5			
	,"RDS_Golf4_Civ_01", 2.0]] call _fnc_saveToTemplate; 			//this line determines civilian cars -- Example: ["vehiclesCivCar", ["C_Offroad_01_F"]] -- Array, can contain multiple assets

["vehiclesCivIndustrial", ["RDS_S1203_Civ_01", 1.0
	,"C_Van_01_box_F", 0.8
	,"RDS_tt650_Civ_01", 0.3
...
["vehiclesCivMedical", ["WH_RC_medevac_F", 0.1]] call _fnc_saveToTemplate;			//this line determines civilian medic vehicles
