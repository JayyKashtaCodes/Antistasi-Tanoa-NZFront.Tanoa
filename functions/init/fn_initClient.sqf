...
if (worldName == "Tanoa") then {petros setName "Māui"} else {petros setName "Petros"};

[petros, ""] call BIS_fnc_setUnitInsignia;
[petros, MyInsignia] call BIS_fnc_setUnitInsignia;
[petros, "Male01GRE"] remoteExec ["setSpeaker", 0, true];
...
//Set Voice
[player, "Male01GRE"] remoteExec ["setSpeaker", 0, true];
//Set Insignia
